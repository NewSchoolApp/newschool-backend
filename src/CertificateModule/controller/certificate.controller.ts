...
@ApiBearerAuth()
@Controller(`${Constants.API_PREFIX}/${Constants.API_VERSION_1}/${Constants.CERTIFICATE_ENDPOINT}`)
export class CertificateController {
  ...
  @ApiOperation({ title: 'Update user', description: 'Update certificate by id' })
  ...
  public async update(
    ...
    return this.mapper.toDto(await this.service.update(
      id, certificate,
    ));
  }
