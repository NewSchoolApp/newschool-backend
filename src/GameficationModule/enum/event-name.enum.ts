export enum EventNameEnum {
  ...
  COURSE_REWARD_COMPLETE_COURSE = 'CourseReward::CompleteCourse',
  USER_REWARD_SHARE_COURSE = 'UserReward::ShareCourse',
  ...
  USER_REWARD_COMPLETE_COURSE = 'UserReward::CompleteCourse'
